...
app = {                              # REQUIRED dict, must be named 'app'
    ...
    'macros' : [                     # List of button macros...
        ...
        (0x202000, 'Note',   [Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ALT, 0.05, -Kc.ALT, 'p', 0.05, 'd', Kc.LEFT_ARROW, -Kc.LEFT_ARROW, Kc.UP_ARROW, -Kc.UP_ARROW, Kc.ENTER]), # Place > (select "Note")
        ...
        # 4th row ----------
        (0x000020, 'Net',    [Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ALT, 0.05, -Kc.ALT, 'p', 0.05, 'n']), # Place > Net Label
		(0x000020, 'Power',  [Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ALT, 0.05, -Kc.ALT, 'p', 0.05, 'o']), # Place > Power Port
