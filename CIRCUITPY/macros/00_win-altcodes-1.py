...
app = {                              # REQUIRED dict, must be named 'app'
    ...
    'macros' : [                     # List of button macros...
        ...
        (0x002020, 'Diam',    [Kc.ALT, Kc.KEYPAD_ZERO, -Kc.KEYPAD_ZERO, Kc.KEYPAD_TWO, -Kc.KEYPAD_TWO, Kc.KEYPAD_FOUR, -Kc.KEYPAD_FOUR, Kc.KEYPAD_EIGHT]), # "ø" = alt+0248 (lowercase) ("Ø" = alt+0216 (uppercase))
