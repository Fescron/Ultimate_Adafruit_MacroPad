...
_INIT_SEQUENCE = (
    ...
    b"\x40\x01\x00"  # 09/12/2023 BRECHTVE: Changed line (before: b"\x40\x00") # set start line
    ...
    b"\xdb\x01\x20"  # 09/12/2023 BRECHTVE: Changed "\x40" to "\x20" # VCOM deselect level = 0.770 (POR)
    b"\x20\x01\x20"  #
